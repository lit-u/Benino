...
def main() -> None:
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ("-h", "--help"):
        ...
        print("    --backend B             gemini|kimi|claude|openai|groq|ollama (default: whichever API key is set)")
    ...
    if cmd == "install":
        ...
        if len(sys.argv) < 3:
            print(
                "Usage: graphify extract <path> [--backend gemini|kimi|claude|openai|groq|ollama] "
